...
__kernel void compute_potential(__global const float3 *volume_matrix_in,    // The matrix of positions representing the volume
                                ...
                                __global const size_t size_mass_matrix,     // The number of positions in the mass matrix
                                __global const float volume_material_mass,  // The mass density of the material the volume matrix is made of
                                __global const float mass_material_mass     // The mass density of the material the mass matrix is made of
    ...
    __global const float G = 0.000062608;                                                           // The gravitational constant
    ...
    potential_matrix_out[volume_voxel_i] = 0.0f;                                                    // Set the starting potential to zero
    for(mass_voxel_i = 0; mass_voxel_i < size_mass_matrix; mass_voxel_i++) {                        // Loop through each element of the mass matrix
        ...
        potential_matrix_out[volume_voxel_i] += (G * volume_material_mass * mass_material_mass) /   // Add the potential due to this voxel of the mass matrix to our potential value
